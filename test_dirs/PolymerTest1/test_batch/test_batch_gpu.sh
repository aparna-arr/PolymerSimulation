...
#################
#set a job name  
#SBATCH --job-name=polymer_test_1
#################  
#a file for job output, you can check job progress, append the job ID with %j to make it unique
#SBATCH --output=polymer_test_1.%j.out
#################
# a file for errors from the job
#SBATCH --error=polymer_test_1.%j.err
#################
...
module load py-cython/0.27.3_py27
...
python ~/builds/openmm-polymer/examples/example/example.py
